...
function buildSqlQuery(req,query,params,cb){
    ...
    // Main query building
output.sqls.push({"datasource": datasource, "type":"main",  "query": (main + ((params.dir!== undefined && params.orderBy !== undefined) ? " order by " + params.orderBy + " " + (params.dir!==undefined ? params.dir  : " desc " ) : " ") + ((params.page!== undefined && params.rowsPerPage !== undefined) ? " limit "+((params.page==0? params.page : params.page))+","+params.rowsPerPage : "")) });
