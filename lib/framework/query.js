...
output.sqls.push({"datasource": datasource, "type":"main",  "query": (main + ((params.page!== undefined && params.rowsPerPage !== undefined) ? " limit "+((params.page - 1) * params.rowsPerPage)+","+params.rowsPerPage : "")) });
