...
exports.format = function(req,cb){
    ...
    if(typeof req.display === "function"){
      ...
      display = _.reject(display, function(obj){ return !(((req.params.dayWise=='true')? obj.key=="daydate" : false) || (obj.key.indexOf('_id')==-1 && req.params.measure.indexOf(obj.key)!=-1) || (obj.key.indexOf('_id')!=-1 && req.params.fields.indexOf(obj.key)!=-1)) });
        logger.info(display);
    }
